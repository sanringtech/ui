...
@Component({
  ...
  imports: [LucideArrowLeft, LucideArrowRight, LucideChevronDown, LucideCopy, I18nPipe],
  template: `
    <header [class]="classes.root">
      <div [class]="classes.heading">
        <h1 [class]="classes.title">{{ titleKey | t }}</h1>
        <p [class]="classes.description">{{ descriptionKey | t }}</p>
      </div>
