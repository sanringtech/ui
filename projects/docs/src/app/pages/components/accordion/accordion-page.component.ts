...
import { IComponentPageHeader } from '../../../type/interface/IComponentPageHeader';
  ...
  template: `
    <article [class]="classes.root">
      <app-component-page-header
        [titleKey]="componentPageHeader.titleKey"
        [descriptionKey]="componentPageHeader.descriptionKey"
      />
...
export class AccordionPageComponent {
  componentPageHeader: IComponentPageHeader = {
    titleKey: 'components.accordion.title',
    descriptionKey: 'components.accordion.description',
  };
