...
const docsSectionClasses = {
  heading: cn('mb-2.5 text-xs font-semibold text-[var(--docs-muted)]'),
  link: cn(
    'my-[3px] flex min-h-8 w-fit items-center rounded-lg px-3',
    'text-sm text-[var(--docs-fg)] no-underline',
  ),
  disabledLink: cn(
    'my-[3px] flex min-h-8 w-fit cursor-not-allowed items-center rounded-lg px-3',
    'text-sm text-[color-mix(in_srgb,var(--docs-muted)_45%,transparent)] no-underline',
  ),
