...
export class ToastService {
  ...
  // Timer tracking — three maps for pause/resume support:
  //   _timers:      active setTimeout handles
  //   _startedAt:   when the current timer segment began
  //   _remaining:   remaining ms at the time the timer last started
