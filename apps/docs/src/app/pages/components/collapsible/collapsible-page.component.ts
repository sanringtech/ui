          ...
          <div previewer class="grid w-[min(520px,100%)] gap-4">
            <div class="flex justify-end">
              <button
                ...
                variant="outline"
                size="sm"
                (click)="controlledOpen.update((open) => !open)"
              >
                {{
                  controlledOpen()
                    ? i18n.t('collapsible.demo.close')
                    : i18n.t('collapsible.demo.open')
                }}
              </button>
            </div>
            ...
            <sanring-collapsible [(open)]="controlledOpen">
              ...
              <div
                ...
                class="px-3 pb-3 pt-2 text-sm leading-6 text-[var(--docs-muted)]"
              >
      ...
      <app-component-page-section [section]="section('examples')">
        <div class="grid gap-2">
          ...
          <app-component-page-section [section]="section('example-settings-panel')">
            <app-component-page-code-previewer
              [code]="examples.settingsPanel"
              language="angular-html"
            >
              <div previewer class="w-[min(560px,100%)]">
                <sanring-collapsible
                  [open]="true"
                  class="block rounded-[var(--sanring-radius)] border border-[var(--docs-border)] bg-[var(--docs-surface)]"
                >
                  <button
                    sanringBtn
                    sanringCollapsibleTrigger
                  ...
                  <div
                    sanringCollapsibleContent
                    class="grid gap-3 border-t border-[var(--docs-border)] p-4"
                  >
            ...
            <app-component-page-code-previewer [code]="examples.fileTree" language="angular-html">
              <div previewer class="w-[min(360px,100%)]">
                <sanring-collapsible [open]="true" class="block font-mono text-sm">
                  ...
                  <div
                    sanringCollapsibleContent
                    class="grid gap-1 border-l border-[var(--docs-border)] ms-4 ps-4"
                  >
