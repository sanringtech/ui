...
export const dropdownMenuPage = {
  ...
  apiRows: [
    ...
    {
      property: 'DropdownMenuContentComponent.id',
      type: 'string',
      defaultValue: 'generated by @angular/aria',
      descriptionKey: 'dropdownMenu.api.id.description',
    },
    {
      property: 'DropdownMenuContentComponent.wrap',
      type: 'boolean',
      defaultValue: 'true',
      descriptionKey: 'dropdownMenu.api.wrap.description',
    },
    {
      property: 'DropdownMenuContentComponent.typeaheadDelay',
      type: 'number',
      defaultValue: '500',
      descriptionKey: 'dropdownMenu.api.typeaheadDelay.description',
    },
    {
    ...
    {
      property: 'DropdownMenuSubTriggerComponent.submenu',
      type: 'Menu | undefined',
      defaultValue: 'required',
      descriptionKey: 'dropdownMenu.api.submenu.description',
    },
    {
      property: 'DropdownMenuSubTriggerComponent.value',
      type: 'unknown',
      defaultValue: 'required',
      descriptionKey: 'dropdownMenu.api.subTriggerValue.description',
    },
...
export class ExampleComponent {}`,
  ...
  >
    ...
    <sanring-dropdown-menu-sub>
      ...
      <sanring-dropdown-menu-sub-content #shareMenu="sanringDropdownMenuSubContent" class="w-48">
    ...
    <sanring-dropdown-menu-sub>
      ...
      <sanring-dropdown-menu-sub-content #exportMenu="sanringDropdownMenuSubContent" class="w-48">
