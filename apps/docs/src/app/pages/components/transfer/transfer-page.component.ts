...
import { ButtonDirective, InputDirective, SANRING_TRANSFER_IMPORTS, TransferItem } from '@sanring/ui';
          ...
          <div previewer class="w-[min(480px,100%)]">
            ...
            >
              <sanring-transfer-panel direction="source" class="h-72 w-56">
                <sanring-transfer-header>{{ i18n.t('transfer.demo.available') }}</sanring-transfer-header>
              ...
              <sanring-transfer-panel direction="target" class="h-72 w-56">
                <sanring-transfer-header>{{ i18n.t('transfer.demo.selected') }}</sanring-transfer-header>
                <sanring-transfer-list />
              </sanring-transfer-panel>
            </sanring-transfer>
          </div>
                  ...
                  <sanring-transfer-panel direction="source" class="h-72 w-56">
                    <sanring-transfer-header>
                      ...
                      <span class="text-xs text-[var(--docs-muted)]">
                        {{ items.length - countedSelectedKeys.length }}
                      </span>
                    </sanring-transfer-header>
                    <sanring-transfer-list />
                  </sanring-transfer-panel>
                ...
                >
                  <sanring-transfer-panel direction="source" class="h-72 w-56" #searchSourcePanel="sanringTransferPanel">
                    ...
                    <input
                      ...
                      (input)="searchSourcePanel.setQuery($any($event.target).value)"
                    />
                    <sanring-transfer-list />
                  </sanring-transfer-panel>
                  ...
                  <sanring-transfer-panel direction="target" class="h-72 w-56" #searchTargetPanel="sanringTransferPanel">
                    ...
                    <input
                      ...
                      [placeholder]="i18n.t('transfer.demo.searchPlaceholder')"
                      class="mx-2 my-1.5 h-8 text-xs"
                      (input)="searchTargetPanel.setQuery($any($event.target).value)"
                    />
                    <sanring-transfer-list />
                  </sanring-transfer-panel>
                </sanring-transfer>
